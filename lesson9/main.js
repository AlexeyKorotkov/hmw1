...
for(const menus of menu){
    // let menuInfoUl=document.createElement('li');
...
for(const course of courses){
    ...
    li.innerText=`${course.title} ${course.monthDuration}`
    ol.appendChild(li);
...
for (const item of coursesArray) {
    ...
    let montDuration = document.createElement('div');
    let hourDuration = document.createElement('div');
    let modules = document.createElement('ul');

    title.innerText = item.title;
    montDuration.innerText = item.monthDuration;
    ...
    durationsWrapper.append(montDuration,hourDuration);
